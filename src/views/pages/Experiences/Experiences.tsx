                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Icon bullet */}
                      <div
                        className={`relative z-10 w-10 h-10 rounded-full bg-white dark:bg-slate-900 border-2 border-sky-400 flex items-center justify-center text-sky-500 group-hover:bg-sky-50 dark:group-hover:bg-sky-900/30 group-hover:scale-110 transition-all duration-300 ${isFirst ? 'animate-[heartbeat_2s_ease-in-out_infinite]' : ''}`}
                      >
                        <FontAwesomeIcon
                      ...
                      <div className="absolute top-12 text-center whitespace-nowrap">
                        <p className="text-[10px] font-semibold text-black dark:text-gray-300 uppercase tracking-wide">
                          {milestone.type === 'work'
                            ? milestone.subtitle
                            : milestone.title}
                        </p>
                        <p className="text-[9px] text-black/60 dark:text-gray-500">
                          {milestone.type === 'work'
                            ? milestone.title
                            : milestone.subtitle}
                        </p>
                ...
                {milestones.map((milestone, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Icon bullet */}
                      <div
                        className={`relative z-10 w-10 h-10 rounded-full bg-white dark:bg-slate-900 border-2 border-sky-400 flex items-center justify-center text-sky-500 shrink-0 ${isFirst ? 'animate-[heartbeat_2s_ease-in-out_infinite]' : ''}`}
                      >
                        <FontAwesomeIcon
                          icon={getIcon(milestone.type)}
                          className="text-sm"
                      ...
                      <div className="flex-1 pb-2">
                        ...
                        <div
                          className={`overflow-hidden transition-all duration-300 ease-out ${
                            showAll || expandedMilestone === index
                ...
                <div
                  ...
                  style={{
                    transitionDelay: showAll
                      ? `${index * 100}ms`
                      : `${(milestones.filter((m) => m.type === 'work').length - index) * 30}ms`,
                  }}
                >
                  {/* Index number */}
            ...
            <div className="p-4 border-b border-gray-100 dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="text-sm font-light uppercase tracking-tight">
                    {hoveredMilestone.title}
                  </h3>
                  <p className="text-xs text-black/60 dark:text-gray-500">

...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      <div className="cursor-none-scope bg-gradient-to-br from-slate-100 via-gray-100 to-sky-100/40 dark:from-[#0a0f1a] dark:via-[#0d1320] dark:to-[#0f172a] text-black dark:text-gray-100 transition-colors duration-300 cursor-none relative min-h-screen">
